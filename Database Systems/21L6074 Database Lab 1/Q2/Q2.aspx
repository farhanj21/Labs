...
<script>
        ...
        let totalConverted;
        if (curr == "Dollar") {
            totalConverted = totalRupees / 250;
        } else if (curr == "Euro") {
            totalConverted = totalRupees / 300;
        } else if (curr == "Pound") {
            totalConverted = totalRupees / 335;
        }
        ...
        let totalConverted;
            if (curr == "Dollar")
            {
            totalConverted = currencyAmount * 250;
            } else if (curr == "Euro")
            {
            totalConverted = currencyAmount * 300;
            } else if (curr == "Pound") {
            totalConverted = currencyAmount * 335;
            }
        ...
        document.getElementById("program").value = "Farhan Jafri";
        }
</script>
...
<body>
    ...
    <p>
       Dollar Rate: 250 Rupees<br />
       Euro Rate: 300 Rupees <br />
       Pound Rate: 335 Rupees<br /><br />
